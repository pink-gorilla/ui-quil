...
var component = ReasonReact.statelessComponent("Alert");

function make($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, _) {
  var color = $staropt$star ? $staropt$star[0] : "teal";
  var heading = $staropt$star$1 ? $staropt$star$1[0] : "Heading here";
  var icon = $staropt$star$2 ? $staropt$star$2[0] : "info";
  var message = $staropt$star$3 ? $staropt$star$3[0] : "A message";
  var newrecord = component.slice();
  newrecord[/* render */9] = (function () {
      var match = +(icon === "warning");
      var match$1 = +(icon === "success");
      var match$2 = +(icon === "info");
      var match$3 = +(icon === "danger");
      return React.createElement("div", {
                  className: "flex bg-" + (String(color) + "-lighter max-w-sm")
                }, React.createElement("div", {
                      className: "w-16 bg-" + (String(color) + "")
                    }, React.createElement("div", {
                          className: "p-4"
                        }, match !== 0 ? React.createElement("svg", {
                                ...
                                xmlns: "http://www.w3.org/2000/svg"
                                  ...
                                  })) : null, match$2 !== 0 ? React.createElement("svg", {
                                className: "h-8 w-8 text-white fill-current",
                                viewBox: "0 0 512 512",
                                xmlns: "http://www.w3.org/2000/svg"
                              }, React.createElement("path", {
                                  ...
                                  })) : null, match$3 !== 0 ? React.createElement("svg", {
                                className: "h-8 w-8 text-white fill-current",
                                viewBox: "0 0 512 512",
                                xmlns: "http://www.w3.org/2000/svg"
                              }, React.createElement("path", {
...
var $$default = ReasonReact.wrapReasonForJs(component, (function (jsProps) {
        return make(/* Some */[jsProps.color], /* Some */[jsProps.heading], /* Some */[jsProps.icon], /* Some */[jsProps.message], /* array */[]);
      }));
